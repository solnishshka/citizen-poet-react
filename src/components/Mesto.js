      ...
      <form className="form form_type_adress">
        <fieldset className="form__fielset form__fieldset_address">
          ...
          <input
            ...
            required
            id="street"
            className="form__input_type_street"
          ></input>
          <div className="form__household-align">
            <label htmlFor="building" className="form__input-label">
              ...
              <input
                ...
                placeholder="12"
                required
                className="form__input_type_building"
              ></input>
            </label>
            ...
            <label htmlFor="corp" className="form__input-label">
              ...
              <input
                id="corp"
                placeholder="2"
                className="form__input_type_corp"
              ></input>
            </label>
            ...
            <label htmlFor="entrance" className="form__input-label">
              ...
              <input
                id="entrance"
                placeholder="3"
                className="form__input_type_entrance"
              ></input>
            </label>
          </div>
          ...
          <textarea
            ...
            id="comments"
            className="form__input_type_comments"
          ></textarea>
        </fieldset>
        <Link to={`${url}/success`}>
