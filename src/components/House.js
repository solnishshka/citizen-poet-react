    ...
    <section className="categories">
      ...
      <div className="table table_theme_house">
        ...
        <Card
          ...
          cardText_2={"Неудовлетворяющее выполнение работ по капитальному ремонту"}
        ></Card>
        <Card
          className={"card__description card__description_theme_problems"}
        ...
        <Card
          ...
          cardText_4={"Повреждение указателей с наименованием улицы и номером дома"}
        ></Card>
        <Card
          className={"card__description card__description_theme_problems"}
          ...
          cardText_3={"Неубранный подъезд, карниз над подъездом, неубранные сосульки"}
